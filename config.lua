...
-- Laita tahan paikka missa voit tuunata
Config.Alue = {
        ls4 = {
		Pos   = { x = -211.73, y = -1324.01, z = 29.89}, -- Coordinaatit
		Size  = {x = 3.0, y = 3.0, z = 0.2}, -- Alueen koko
		Color = {r = 204, g = 204, b = 0}, -- Blipin vari eli eli toi marrkerin vari
		Marker= -1, -- Ei tata tarvii:D
		Name  = "Tuunaamo",
...
Config.Menus = {
	...
	modSuspension = {
		...
		price = {5.43, 9.42, 11.53, 16.2, 25.99}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		...
		price = {35.2, 50.34, 100.64, 120.69, 140.34, 150}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
